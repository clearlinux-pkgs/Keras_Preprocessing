...
Version  : 1.1.1
Release  : 28
URL      : https://files.pythonhosted.org/packages/75/fb/1be74e0b62c5e04e3210b828fc14db198a853a7445d6bbe4651335470387/Keras_Preprocessing-1.1.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/75/fb/1be74e0b62c5e04e3210b828fc14db198a853a7445d6bbe4651335470387/Keras_Preprocessing-1.1.1.tar.gz
...
%prep
%setup -q -n Keras_Preprocessing-1.1.1
cd %{_builddir}/Keras_Preprocessing-1.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589307260
...
cp %{_builddir}/Keras_Preprocessing-1.1.1/LICENSE %{buildroot}/usr/share/package-licenses/Keras_Preprocessing/6019559c8c61a5f991dd1f3bd223efa1c6781ef6
